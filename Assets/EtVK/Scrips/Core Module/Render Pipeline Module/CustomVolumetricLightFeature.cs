...
{
    public class CustomVolumetricLightFeature : ScriptableRendererFeature
{
public enum DownSample { off = 1, half = 2, third = 3, quarter = 4 };
    ...
    public class Settings
    {
        ...
        {
            public float samples= 8;
            public float jitterMultiplier=2;
            public float maxDistance= 28;
            public float colorBoost = 3;
        }
    ...
    class Pass : ScriptableRenderPass
    {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            try
            {
                ...
                //color settings
                settings.material.SetFloat("_Boost", settings.colorSettings.colorBoost);
                settings.material.SetFloat("_DepthSteps", settings.colorSettings.samples);
                settings.material.SetFloat("_DepthMaxDistance", settings.colorSettings.maxDistance);
                settings.material.SetFloat("_ColorJitterMultiplier", settings.colorSettings.jitterMultiplier);
